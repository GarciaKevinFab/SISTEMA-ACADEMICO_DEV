...
const Login = () => {
  ...
  >
    ...
    <div className="relative max-w-4xl w-full bg-white/80 backdrop-blur-xl p-10 rounded-2xl shadow-2xl flex flex-col md:flex-row border border-white/40">
      ...
      {/* Formulario */}
      <div className="w-full md:w-2/3 space-y-6 px-6">
        <h2 className="text-center text-3xl font-extrabold text-gray-900 font-montserrat">
          SISTEMA ACADEMICO
        </h2>

        {/* LOGUITO MISMO TAMAÑO QUE EL COLIBRÍ */}
<div className="flex justify-center">
  <img
    src="/loguito.png"
    alt="Logotipo secundario"
    className="object-contain w-[180px] md:w-full h-auto md:h-[115px] opacity-95"
    draggable="false"
  />
</div>
  ...
  className={`group relative w-full flex justify-center py-2.5 px-4
              text-sm font-bold rounded-md shadow-md
              transition-all duration-200 ease-in-out
              ${loading
                ? "bg-gray-400 text-white cursor-not-allowed"
                : "bg-[#1E2F49] text-white hover:bg-[#162338] hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#1E2F49]"
              }`}
>
